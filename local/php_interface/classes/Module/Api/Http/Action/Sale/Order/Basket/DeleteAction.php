...
/**
 * Action удаления позиции с товаром из корзины пользователя
...
class DeleteAction
{
    ...
    /**
     * @OA\Delete(
     *     summary="Удаляет позицию с товаром из корзины пользователя",
     *     description="",
     *     path="/api/v1/sale/order/basket/item/{basket_item_id}/",
     *     operationId="v1-sale-order-basket-item-delete",
     *     tags={"basket"},
     *     @OA\Parameter(
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        try {
            ...
            $this->basketService->deleteFromBasket($basketItemId);
