...
$APPLICATION->SetPageProperty("description", "Подробные условия доставки ягодно-фруктовых букетов в Москве и Санкт-Петербурге. Доставляем в ближайшее время и  даже ночью!");
$APPLICATION->SetPageProperty("title", "Условия доставки ягодно-фруктовых букетов и цветов | Very Berry");
$APPLICATION->SetTitle("Доставка");
?>    <div class='container'>
        <h1>Вопросы по доставке</h1>
